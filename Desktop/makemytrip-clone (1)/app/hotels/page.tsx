        ...
        <Card className="my-12 bg-white rounded-xl overflow-hidden shadow-lg">
          <div className="p-8 relative">
            <div className="relative z-10 bg-white rounded-xl p-6">
              ...
              <div className="flex items-center justify-between mb-8">
                <RadioGroup defaultValue="rooms" className="flex items-center gap-6">
                  <div className="flex items-center gap-2">
                    ...
                    <Label htmlFor="rooms" className="text-sm font-medium whitespace-nowrap">
                      Upto 4 Rooms
                    </Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="group" id="group" className="text-red-600" />
                    <Label htmlFor="group" className="text-sm font-medium flex items-center gap-1">
                      Group Deals
                      <span className="bg-red-100 text-red-600 text-[10px] px-1 rounded">new</span>
                    </Label>
                  </div>
                </RadioGroup>
              ...
              {/* Hotel Search Form */}
              <div className="grid grid-cols-[2fr,1fr,1fr,1fr] gap-4 mb-8">
                {/* City/Hotel */}
                <div className="border rounded-lg p-3 cursor-pointer hover:border-blue-500 bg-white transition-all duration-300 shadow-sm hover:shadow-md">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    variant="outline"
                    className="text-sm bg-white hover:bg-blue-50 transition-colors duration-300"
                  >
                    ₹0-₹1500
              ...
              <div className="flex justify-center">
                <Link href="/hotels/search">
                  <Button className="bg-red-600 hover:bg-red-700 text-white px-16 py-6 text-xl font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl">
                    SEARCH
                  </Button>
                </Link>
              </div>
